...
const en = {
  ...
  imageFactoryTitle: "Set up Image Factory",
  imageFactorySubtitle: "Choose the ChatGPT project used for generated-image conversations. Image children inherit the parent Codex model and effort. Instant uses low reasoning and may return the wrong number of images for multi-image requests; choose Medium or higher when exact count matters.",
  imageFactoryProject: "ChatGPT project",
  imageFactoryProjectId: "project_id",
  imageFactoryProjectName: "Project name (fallback)",
  imageFactoryProjectHelp: "Open the project in ChatGPT and copy the g-p-… segment from its URL, for example https://chatgpt.com/g/g-p-…/project. The project opens directly by ID. Enter its exact name in Pinned for fallback navigation.",
  imageFactorySave: "Save project",
  imageFactorySaving: "Saving…",
  imageFactoryConfigured: "Image Factory is configured.",
  imageFactoryNotConfigured: "Image Factory is not configured. Image generation will fail until project_id is saved here.",
  activity: "Activity",
  settings: "Settings",
...
const zh: Record<keyof typeof en, string> = {
  ...
  setup: "设置",
  imageFactory: "Image Factory",
  imageFactoryTitle: "设置 Image Factory",
  imageFactorySubtitle: "选择用于生成图片对话的 ChatGPT 项目。图片子任务会继承父 Codex 的模型和推理级别。Instant 使用较低推理，多图请求可能返回错误的图片数量；需要精确数量时请选择 Medium 或更高级别。",
  imageFactoryProject: "ChatGPT 项目",
  imageFactoryProjectId: "project_id",
  imageFactoryProjectName: "项目名称（备用导航）",
  imageFactoryProjectHelp: "在 ChatGPT 中打开项目，并从 URL 中复制 g-p-… 段，例如 https://chatgpt.com/g/g-p-…/project。项目将通过 ID 直接打开。填写 Pinned 中的准确名称，以便在需要时通过名称打开。",
  imageFactorySave: "保存项目",
  imageFactorySaving: "正在保存…",
  imageFactoryConfigured: "Image Factory 已配置。",
  imageFactoryNotConfigured: "Image Factory 尚未配置。保存 project_id 之前，图片生成会返回配置错误。",
  activity: "活动",
  settings: "设置项",
  updateAvailable: "更新至",
  updating: "正在更新…",
...
const ja: Record<keyof typeof en, string> = {
  ...
  setup: "セットアップ",
  imageFactory: "Image Factory",
  imageFactoryTitle: "Image Factory をセットアップ",
  imageFactorySubtitle: "画像生成の会話に使用する ChatGPT プロジェクトを選択します。画像の子タスクは親 Codex のモデルと推論レベルを継承します。Instant は推論が低く、複数画像の要求数を外す場合があります。正確な枚数が必要な場合は Medium 以上を選択してください。",
  imageFactoryProject: "ChatGPT プロジェクト",
  imageFactoryProjectId: "project_id",
  imageFactoryProjectName: "プロジェクト名（予備の移動先）",
  imageFactoryProjectHelp: "ChatGPT でプロジェクトを開き、URL の g-p-… 部分をコピーします。例: https://chatgpt.com/g/g-p-…/project。ID で直接開きます。必要な場合に Pinned から開けるよう、正確なプロジェクト名を入力してください。",
  imageFactorySave: "プロジェクトを保存",
  imageFactorySaving: "保存中…",
  imageFactoryConfigured: "Image Factory は設定済みです。",
  imageFactoryNotConfigured: "Image Factory は未設定です。project_id を保存するまで画像生成は設定エラーになります。",
  activity: "アクティビティ",
  settings: "設定",
