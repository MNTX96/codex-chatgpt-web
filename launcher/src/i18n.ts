...
const en = {
  ...
  imageFactoryProjectHelp: "Open the project in ChatGPT and copy the g-p-… segment from its URL, for example https://chatgpt.com/g/g-p-…/project. Only this project_id is required.",
  imageFactorySave: "Save project_id",
...
const zh: Record<keyof typeof en, string> = {
  ...
  imageFactoryProjectId: "project_id",
  imageFactoryProjectHelp: "在 ChatGPT 中打开项目，并从 URL 中复制 g-p-… 段，例如 https://chatgpt.com/g/g-p-…/project。这里只需要 project_id。",
  imageFactorySave: "保存 project_id",
...
const ja: Record<keyof typeof en, string> = {
  ...
  imageFactoryProjectId: "project_id",
  imageFactoryProjectHelp: "ChatGPT でプロジェクトを開き、URL の g-p-… 部分をコピーします。例: https://chatgpt.com/g/g-p-…/project。必要なのは project_id だけです。",
  imageFactorySave: "project_id を保存",
