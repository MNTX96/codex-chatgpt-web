...
const en = {
  ...
  imageFactorySubtitle: "Choose the ChatGPT project used for generated-image conversations.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  imageFactorySubtitle: "选择用于生成图片对话的 ChatGPT 项目。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  imageFactorySubtitle: "画像生成の会話に使用する ChatGPT プロジェクトを選択します。",
